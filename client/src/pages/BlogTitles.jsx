...
const BlogTitles = () => {
  ...
  const blogCategories = [ 'General', 'Technology', 'Health', 'Lifestyle', 'Travel', 'Food', 'Education', 'Finance', 'Entertainment', 'Sports' ]
...
return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <br/>
      <button disabled={loading} className='w-full flex justify-center items-center gap-2 mt-6 bg-gradient-to-r from-[#C341F6] to-[#8E37EB] text-white px-4 py-2 text-sm rounded-lg cursor-pointer '>
      ...
      {/* right col*/}
       <div className='w-full max-w-lg bg-white p-4 rounded-lg flex flex-col border border-gray-200 min-h-96 '>
         <div className='flex items-center gap-3'>
            <Hash className='w-5 h-5 text-[#9E37EB]'/>
            <h1 className='text-xl font-semibold'>Genegated Titles</h1>
         </div>
          { !content ? (
