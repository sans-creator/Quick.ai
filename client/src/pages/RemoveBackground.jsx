...
const RemoveBackground = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <p className='test-xs text-gray-500 font-light mt-1'>Supports JPG, PNG, and other image formats</p>

      <button disabled={loading} className='w-full flex justify-center items-center gap-2 mt-6 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 text-sm rounded-lg cursor-pointer '>
        {
