...
const ReviewResume = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <p className='test-xs text-gray-500 font-light mt-1'>Supports PDF resume format only</p>

      <button className='w-full flex justify-center items-center gap-2 mt-6 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 text-sm rounded-lg cursor-pointer '>
        {
       ...
       <div className='w-full max-w-lg bg-white p-4 rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
         ...
         {!content ? (
          ...
          <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
            ...
            <p>Upload an resume and click "Remove Background" to get started</p>
          </div>
         </div>
         ) : (
